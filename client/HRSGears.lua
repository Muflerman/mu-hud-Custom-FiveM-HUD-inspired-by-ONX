...
Citizen.CreateThread(function()
    ...
    while true do
      ...
      -- Asegurarse de que vehicleModels sea siempre una tabla
vehicleModels = vehicleModels or {}

-- Verificar si el modelo del vehículo actual está en vehicleModels
...
-- Ahora puedes usar isInVehicleModel sin riesgo de error
